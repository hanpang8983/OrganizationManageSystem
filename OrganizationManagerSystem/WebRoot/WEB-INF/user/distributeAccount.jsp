	...
	<div class="content">
		<div class="content">
			<div class="org-wrap">
				...
				<div class="org-data">
					<form action="user_distributeAccount.action?person.id=${person.id }" method="post" class="add-input">
						<input type="text" name="user.name" placeholder="用户账号"
							class="input-add-org" /></br> <input type="text" name="user.password"
							placeholder="用户密码" class="input-add-org" /></br> <input type="text"
							name="expireTime" placeholder="有效日期"
