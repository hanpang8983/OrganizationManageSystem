	...
	<div class="content">
		<div class="content">
			<div class="org-wrap">
				...
				<div class="org-data">
					<form action="person_add.action" method="post" class="add-input">
						...
						女&nbsp;<input type="radio"
							name="sex" value="女" /></br> 
						<input type="text" name="person.duty"
							placeholder="职务" class="input-add-org" /></br> 
						<input type="text"
							name="birthday" placeholder="生日"
							onclick="fPopCalendar(event,this,this)" class="input-add-org" /></br>
						<input type="text" name="person.address" placeholder="家庭地址"
							class="input-add-org" /></br> 
						<input type="text" name="person.phone"
							placeholder="电话" class="input-add-org" /></br>
						<!-- 
						<input type="text" name="org" placeholder="所属机构" onclick="openWin('select_org.jsp','选择机构',600,300,1);" class="input-add-org" /></br> 
						 -->
						<input type="hidden" name="orgId" id="orgId">
						<input type="text" name="orgName" placeholder="所属机构" id="orgName"
							onclick="selectOrg();" class="input-add-org" /></br> 
						<input
							type="submit" value="保 存" class="btn-sub" />
					</form>
				</div>
			</div>
		</div>
